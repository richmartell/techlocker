@php
    $title = 'Steering, Suspension & Wheel Alignment - ' . ($vehicle->make?->name ?? 'Unknown') . ' ' . ($vehicle->model?->name ?? 'Unknown');
@endphp
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <nav class="flex items-center gap-2 text-sm text-zinc-600 dark:text-zinc-400 mb-4">
                ...
                <flux:icon.chevron-right class="w-4 h-4" />
                <span class="text-zinc-900 dark:text-zinc-100">Steering, Suspension & Wheel Alignment</span>
            </nav>

            <div class="flex items-center gap-3 mb-2">
                <flux:icon.cog-8-tooth class="w-6 h-6 text-zinc-500 dark:text-zinc-400" />
                <h1 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100">Steering, Suspension & Wheel Alignment</h1>
            </div>
            <p class="text-zinc-600 dark:text-zinc-400">
                Steering and suspension specifications for {{ $vehicle->make?->name ?? 'Unknown' }} {{ $vehicle->model?->name ?? 'Unknown' }} ({{ $vehicle->registration }})
            </p>
        </div>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-sm text-red-800 dark:text-red-200">
                            <strong>Error loading steering data:</strong> {{ $error }}
                        </p>
                    </div>
                </div>
            </div>
                                                ...
                                                <table class="w-full">
                                                    <tbody class="divide-y divide-zinc-200 dark:divide-zinc-700">
                                                        @foreach($subsection['subAdjustments'] as $item)
                                                            ...
                                                            <!-- Handle nested sub-specifications if any -->
        ...
        @else
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-700 overflow-hidden">
                <div class="p-8 text-center">
                    ...
                    <h3 class="text-lg font-medium text-zinc-900 dark:text-zinc-100 mb-2">No Steering Data Available</h3>
                    <p class="text-zinc-600 dark:text-zinc-400">
                        Steering, suspension and wheel alignment data could not be loaded from the HaynesPro API for this vehicle.
                    </p>
                </div>
            </div>
        @endif
        ...
        @if(!empty($steeringData))
            <div class="mt-6 bg-zinc-50 dark:bg-zinc-800 rounded-lg border border-zinc-200 dark:border-zinc-700 p-4">
                <h3 class="text-sm font-medium text-zinc-900 dark:text-zinc-100 mb-3">Steering & Alignment Terms</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 text-xs">
                    ...
                    <div class="flex gap-2">
                        ...
                        <span class="text-zinc-600 dark:text-zinc-400">Degrees (angle)</span>
                    </div>
                    <div class="flex gap-2">
                        <span class="font-medium text-zinc-700 dark:text-zinc-300">Toe-in/out:</span>
                        <span class="text-zinc-600 dark:text-zinc-400">Wheel alignment angle</span>
                    </div>
                    <div class="flex gap-2">
                        <span class="font-medium text-zinc-700 dark:text-zinc-300">Camber:</span>
                        <span class="text-zinc-600 dark:text-zinc-400">Wheel vertical tilt</span>
                    </div>
                    <div class="flex gap-2">
                        <span class="font-medium text-zinc-700 dark:text-zinc-300">Castor:</span>
                        <span class="text-zinc-600 dark:text-zinc-400">Steering axis tilt</span>
                    </div>
                    <div class="flex gap-2">
                        <span class="font-medium text-zinc-700 dark:text-zinc-300">Thrust angle:</span>
                        <span class="text-zinc-600 dark:text-zinc-400">Rear axle alignment</span>
                    </div>
                </div>
            </div>
        @endif
