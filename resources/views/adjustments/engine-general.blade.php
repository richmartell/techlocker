            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    <p class="text-sm text-blue-800 dark:text-blue-200">
                        @if(!empty($engineAdjustments))
                            <strong>Live Data:</strong> Engine specifications are dynamically fetched from the HaynesPro API 
                            based on this vehicle's car type ID ({{ $vehicle->car_type_id ?? 'Not available' }}).
                        @else
                            <strong>No Data Available:</strong> Engine adjustments could not be loaded from the HaynesPro API. 
