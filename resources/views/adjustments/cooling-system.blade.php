            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    <p class="text-sm text-blue-800 dark:text-blue-200">
                        @if(!empty($coolingSystemData))
                            <strong>Live Data:</strong> Cooling system specifications are dynamically fetched from the HaynesPro API 
                            based on this vehicle's car type ID ({{ $vehicle->car_type_id ?? 'Not available' }}). Data includes pressure values, thermostat temperatures, and system capacities.
                        @else
                            <strong>No Data Available:</strong> Cooling system specifications could not be loaded from the HaynesPro API. 
