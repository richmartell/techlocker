@php
    $title = 'Wheels and Tyres - ' . ($vehicle->make?->name ?? 'Unknown') . ' ' . ($vehicle->model?->name ?? 'Unknown');
@endphp
    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <nav class="flex items-center gap-2 text-sm text-zinc-600 dark:text-zinc-400 mb-4">
                ...
                <flux:icon.chevron-right class="w-4 h-4" />
                <span class="text-zinc-900 dark:text-zinc-100">Wheels and Tyres</span>
            </nav>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-sm text-red-800 dark:text-red-200">
                            <strong>Error loading wheels and tyres data:</strong> {{ $error }}
                        </p>
                    </div>
                </div>
            </div>
        ...
        @else
            ...
            <div class="bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-700 overflow-hidden">
                <div class="p-8 text-center">
                    ...
                    <h3 class="text-lg font-medium text-zinc-900 dark:text-zinc-100 mb-2">No Wheels and Tyres Data Available</h3>
                    <p class="text-zinc-600 dark:text-zinc-400">
                        Wheels and tyres data could not be loaded from the HaynesPro API for this vehicle.
                    </p>
                </div>
            </div>
        @endif
